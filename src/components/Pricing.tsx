...
<section className='bg-white'>
  <div className="mx-auto w-full max-w-7xl px-5 py-16 text-center md:px-10 md:py-24 lg:py-24">
    <h2 className="text-3xl font-semibold md:text-5xl">
      <span className="bg-cover bg-center bg-no-repeat px-4 text-white" style={{backgroundImage: 'url(https://assets.website-files.com/63904f663019b0d8edf8d57c/63915f9749aaab0572c48dae_Rectangle%2018.svg)'}}>Simple &amp; Affordable</span> Pricing
    </h2>
    ...
    <div className="mx-auto mb-8 grid w-full grid-cols-1 gap-4 rounded-3xl bg-[#f5f8ff] p-8 md:mb-12 md:grid-cols-[1.25fr_0.25fr_0.75fr] md:p-16 lg:mb-16 lg:w-4/5 lg:grid-cols-[1.75fr_0.5fr_0.75fr]">
      ...
      <div className="flex flex-col items-start">
        <h2 className="mb-4 text-left text-3xl font-semibold md:text-5xl">$99<span className="text-sm font-light">/month</span>
        </h2>
        <a href="#" className="inline-block w-full rounded-xl bg-black px-8 py-4 text-center font-semibold text-white [box-shadow:rgb(19,_83,_254)_6px_6px]">Get started</a>
      </div>
    </div>
