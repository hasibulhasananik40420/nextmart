  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-24">
    <div className="flex flex-col items-center">
      <div className="mb-8 max-w-[800px] text-center md:mb-12 lg:mb-16">
        <h2 className="text-3xl font-semibold md:text-5xl">The latest and greatest news</h2>
      ...
      <div className="mb-8 grid w-full grid-cols-1 md:mb-12 md:grid-cols-3 md:gap-4 lg:mb-16">
        <a href="#" className="relative mb-12 flex h-[560px] max-w-full grid-cols-1 flex-col gap-4 overflow-hidden rounded-xl border border-solid border-black bg-white font-bold text-black [box-shadow:rgb(0,_0,_0)_9px_9px] [grid-area:1/1/2/2] md:[grid-area:1/1/2/4]">
          <div className="absolute bottom-0 left-0 right-0 top-auto z-20 flex w-full max-w-[800px] flex-col items-start justify-start rounded-xl bg-white p-6 md:bottom-2 md:left-2">
            <p className="mb-4 rounded-md bg-white py-1.5 text-sm font-semibold text-[#1353fe]">CATEGORY NAME</p>
            <p className="mb-4 text-xl font-bold md:text-2xl">Diam cursus a ornare massa orci sodales habitasse gravida bibendum.</p>
        ...
        <a href="#" className="max-[767px]: flex max-w-full grid-cols-1 flex-col gap-4 rounded-md bg-white py-4 font-bold text-black lg:px-2">
          ...
          <div className="flex w-full flex-col items-start justify-start py-4">
            ...
            <p className="font-normal text-[#636262]">Lorem ipsum dolor sit amet, &nbsp;elit ut aliquam, purus sit amet luctus venenatis elit ut aliquam,</p>
          </div>
        </a>
      ...
      <a href="#" className="inline-block rounded-xl bg-black px-8 py-4 text-center font-semibold text-white [box-shadow:rgb(19,_83,_254)_6px_6px]">View More</a>
    </div>
  </div>
</section>
    </div>
