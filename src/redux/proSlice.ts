...
export const {addToCart,increaseQuantity,decreaseQuantity,deleteProduct,deleteUser,addToFavorite,addUser,deleteFavorite,resetCart,resetFavorite,addOrder,resetOrder} = proSlice.actions 
